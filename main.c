 ...
 *
 * Назначение:
 * main.c разбирает аргументы командной строки и вызывает нужный режим:
 *
 * 1. Индексация:
 *
 ...
 *
 * main.c не должен реализовывать деревья, поиск или сериализацию.
 * Он только связывает CLI с index/search слоями.
 *
 * Важно:
 * Формат CLI должен оставаться стабильным,
 * потому что app.py и benchmark-скрипты будут вызывать именно эти команды.
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
